...
Public Class ConnectionSetup
    Dim Testmyconnection As New SqlConnection
    ...
    Private Sub ConnectionSetup_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        roundCornes(Me)
    ...
    Private Async Sub btnTestConnection_Click_1(sender As Object, e As EventArgs) Handles btnTestConnection.Click
        Me.Text = "🔄 Checking connection..."
        progressBar.Style = ProgressBarStyle.Marquee
        progressBar.Visible = True
        SendMessage(progressBar.Handle, PBM_SETMARQUEE, 1, 10) ' 50 = speed (lower is faster)
    ...
    Private Sub BtnConfigSmtp_Click(sender As Object, e As EventArgs) Handles BtnConfigSmtp.Click
