...
Public Class ConfigSendToClose
    ...
    Private Sub ConfigSendToClose_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        TxtNotifyToClose_InsertRecord_Hours.Text = My.Settings.NotifyToClose_InsertRecord_Hours
        TxtNotifyToClose_InsertRecord_Mins.Text = My.Settings.NotifyToClose_InsertRecord_Mins
        TxtNotifyToClose_InsertRecord_Sec.Text = My.Settings.NotifyToClose_InsertRecord_Sec
        TxtNotifyToClose_InsertRecord_Milli.Text = My.Settings.NotifyToClose_InsertRecord_Milli
    ...
    Private Sub BtnSave_Click(sender As Object, e As EventArgs) Handles BtnSave.Click
        ...
        My.Settings.NotifyToClose_InsertRecord_Hours = TxtNotifyToClose_InsertRecord_Hours.Text
        My.Settings.NotifyToClose_InsertRecord_Mins = TxtNotifyToClose_InsertRecord_Mins.Text
        My.Settings.NotifyToClose_InsertRecord_Sec = TxtNotifyToClose_InsertRecord_Sec.Text
        My.Settings.NotifyToClose_InsertRecord_Milli = TxtNotifyToClose_InsertRecord_Milli.Text
    ...
    Private Sub BtnReset_Click(sender As Object, e As EventArgs) Handles BtnReset.Click
        ...
        If result = DialogResult.Yes Then
            ...
            My.Settings.NotifyToClose_InsertRecord_Hours = ""
            My.Settings.NotifyToClose_InsertRecord_Mins = ""
            My.Settings.NotifyToClose_InsertRecord_Sec = ""
            My.Settings.NotifyToClose_InsertRecord_Milli = ""
            ...
            TxtNotifyToClose_InsertRecord_Hours.Text = ""
            TxtNotifyToClose_InsertRecord_Mins.Text = ""
            TxtNotifyToClose_InsertRecord_Sec.Text = ""
            TxtNotifyToClose_InsertRecord_Milli.Text = ""
    ...
    Private Sub Recalculate_sms_milliseconds_Interval_for_Sending_Sms_Notification()
        ...
        If Not String.IsNullOrEmpty(TxtNotifyToClose_InsertRecord_Hours.Text) Then
            If Integer.TryParse(TxtNotifyToClose_InsertRecord_Hours.Text, Sending_Sms_Notification_hours) = False Then
        ...
        If Not String.IsNullOrEmpty(TxtNotifyToClose_InsertRecord_Mins.Text) Then
            If Integer.TryParse(TxtNotifyToClose_InsertRecord_Mins.Text, Sending_Sms_Notification_minutes) = False Then
        ...
        If Not String.IsNullOrEmpty(TxtNotifyToClose_InsertRecord_Sec.Text) Then
            If Integer.TryParse(TxtNotifyToClose_InsertRecord_Sec.Text, Sending_Sms_Notification_seconds) = False Then
        ...
        If String.IsNullOrEmpty(TxtNotifyToClose_InsertRecord_Hours.Text) AndAlso
           String.IsNullOrEmpty(TxtNotifyToClose_InsertRecord_Mins.Text) AndAlso
           String.IsNullOrEmpty(TxtNotifyToClose_InsertRecord_Sec.Text) Then
            TxtNotifyToClose_InsertRecord_Milli.Text = "" ' Clear the output if no input
            Return
        End If
        ...
        TxtNotifyToClose_InsertRecord_Milli.Text = Sending_Sms_Notification_milliseconds.ToString()
    End Sub
    ...
    Private Sub NotifyToClose_Hours_TextChanged(sender As Object, e As EventArgs) Handles TxtNotifyToClose_InsertRecord_Hours.TextChanged
        Recalculate_sms_milliseconds_Interval_for_Sending_Sms_Notification()
    End Sub

    Private Sub TxtNotifyToClose_Mins_TextChanged(sender As Object, e As EventArgs) Handles TxtNotifyToClose_InsertRecord_Mins.TextChanged
        Recalculate_sms_milliseconds_Interval_for_Sending_Sms_Notification()
    End Sub

    Private Sub TxtNotifyToClose_Sec_TextChanged(sender As Object, e As EventArgs) Handles TxtNotifyToClose_InsertRecord_Sec.TextChanged
        Recalculate_sms_milliseconds_Interval_for_Sending_Sms_Notification()
    End Sub
    ...
    Private Sub TxtNotifyToCloseRecurring_Milli_TextChanged(sender As Object, e As EventArgs) Handles TxtNotifyToCloseRecurring_Milli.TextChanged
